          ...
          <div className="relative rounded-2xl bg-white/5 backdrop-blur-xl ring-1 ring-white/10 p-6 shadow-2xl overflow-hidden">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center justify-center mt-6">
                <div className="h-24 md:h-28 flex items-center justify-center gap-[6px]">
                  {bars.map((h, i) => (
                    <div
                      key={i}
                      className="w-[6px] rounded-full bg-gradient-to-t from-emerald-400/40 via-emerald-300/70 to-emerald-100 transition-all duration-75"
                      style={{ height: `${h}px` }} 
                      aria-hidden
                    />
                  ))}
